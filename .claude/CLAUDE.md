...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-17 (commit 110a861). Confidence: 100%.
...
- `src/components/header.tsx` — 1 bug fix, last fix 4 days ago; 4 commits/90d
- `public/fechar-a-conta/index.html` — 3 commits/90d
- `src/app/layout.tsx` — 3 commits/90d

### Code health
Three co-equal signals: defect risk 9.49/10 avg, hotspot health 8.21/10 (stable), worst `public/fechar-a-conta/supabase.js` at 5.5/10 · maintainability 9.49/10 · performance risk 4 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `src/app/layout.tsx` — change entropy — impact −3.0
- `src/components/header.tsx` — change entropy — impact −2.6
