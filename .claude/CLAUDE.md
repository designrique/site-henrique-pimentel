...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-28 (commit ad23d4e). Confidence: 100%.
...
- `src/components/header.tsx` — 3 bug fixes, last fix 8 days ago; 6 commits/90d
- `public/fechar-a-conta/index.html` — 3 commits/90d
- `src/app/layout.tsx` — 3 commits/90d
- `src/content/posts/index.ts` — 8 commits/90d

### Code health
Three co-equal signals: defect risk 9.48/10 avg, hotspot health 8.09/10 (stable), worst `public/fechar-a-conta/supabase.js` at 5.5/10 · maintainability 9.46/10 · performance risk 4 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `src/content/posts/index.ts` — change entropy — impact −3.0
- `src/app/layout.tsx` — change entropy — impact −3.0
- `src/components/header.tsx` — change entropy — impact −1.8
- `src/components/header.tsx` — prior defect — impact −1.2
