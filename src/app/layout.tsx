...
import { Raleway, Jost, Fraunces, JetBrains_Mono } from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html
      ...
      className={`${raleway.variable} ${jost.variable} ${fraunces.variable} ${jetbrainsMono.variable} h-full antialiased`}
    >
      <head>
        <script
